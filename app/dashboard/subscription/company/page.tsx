...
import { useEditCompany, useFetchCompanyData } from '@/hooks/useCompany'
            ...
            <div className="pt-20 px-4 sm:px-6 lg:px-8 py-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-gray-600 text-sm">Subscription Id:- <span className='underline'>{user?.subscriptionId}</span></p>
                    ...
                    {isLoading ?
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                <fieldset disabled={!CAN_EDIT.includes(userRole)}>
                                    {/* Company Information */}
                                    <div>
                                    ...
                                    {/* Address Information */}
                                    <div>
                                        <h2 className="font-medium text-gray-900 mb-4 mt-6">Address Information</h2>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <h2 className="font-medium text-gray-900 mb-4 mt-9">Settings</h2>
                                        <div>
                                            <label htmlFor="rentDueDay" className="block text-sm font-medium text-gray-700 mb-1">
                                                Day Rent will be due on eg(1st, 15th, 28th), default is the 1st
                                            </label>
                                            <input
                                                id="rentDueDay"
                                                type="text"
                                    ...
                                    {CAN_EDIT.includes(userRole) ? (
                                        ...
                                        isPending ?
                                            <Spinner />
                                            :
                                            <div className="flex flex-col sm:flex-row gap-3 pt-12 border-t border-gray-200">
                                                <button
                                                    type="submit"
