...
export default function AddTenantPage() {
    ...
    const { data: properties, isPending: propertiesLoading, error: propertiesError } = useFetchAllProperties()
    ...
    const onSubmit = async (formData: TenantForm) => {
        ...
        // Send categories as a simple array in the SAME ORDER as files
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                            <div className="flex justify-center items-center py-12">
                                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#876D4A]"></div>
                            </div>
                        </div>
                    </div>
                </div>
